    ...
    return Scaffold(
      ...
      body: FutureBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshotDetail) {
          ...
          if (!snapshotDetail.hasData || snapshotDetail.data!.docs.isEmpty) {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InfoDetailSiswa(
                                    data: data,
                                    icon: Icon(Icons.wc),
                                    isi: 'namaIbu'.isNotEmpty ? 'namaIbu' : "-",
                                  ),
                                ],
                              ),
                            ),
...
class InfoDetailSiswa extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(children: [icon, SizedBox(width: 10), Text(data[isi])]),
    );
  }
}
