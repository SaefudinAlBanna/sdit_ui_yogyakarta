...
//         }),
//         centerTitle: true,
//         // --- TOMBOL BARU DI APPBAR ---
//         actions: [
//           Obx(() {
//             // Tampilkan tombol hanya jika kelas sudah dipilih
//             if (controller.kelasTerpilih.value != null) {
//               return IconButton(
//                 icon: const Icon(Icons.people_outline),
//                 tooltip: "Lihat Siswa di Kelas Ini",
//                 onPressed: () => _showDaftarSiswaBottomSheet(context),
//               );
//             }
//             return const SizedBox.shrink();
//           }),
...
//   // --- WIDGET BARU: BOTTOM SHEET DAFTAR SISWA ---
//   void _showDaftarSiswaBottomSheet(BuildContext context) {
//     Get.bottomSheet(
//       DraggableScrollableSheet(
//         initialChildSize: 0.5,
...
//   // Sisa dari kode view tidak berubah, hanya menyalin ulang untuk kelengkapan
//   Widget _buildKelasSelector() {
//     return Container(
//       padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 12),
//       color: Colors.white,
...
//               popupProps: const PopupProps.menu(showSearchBox: true, fit: FlexFit.loose),
//               items: (f, cs) => controller.getDataWaliKelasBaru(),
//               onChanged: (value) => controller.onWaliKelasSelected(value),
//               decoratorProps: const DropDownDecoratorProps(
//                 decoration: InputDecoration(
//                   labelText: "Pilih Wali Kelas",
//                   border: OutlineInputBorder(),
...
//                         trailing: IconButton(
//                           icon: Icon(Icons.add_circle_outline, color: Theme.of(context).primaryColor),
//                           onPressed: () => controller.simpanKelasBaruLagi(namaSiswa, nisnSiswa),
//                         ),
//                       );
//                     },
//                   ));
