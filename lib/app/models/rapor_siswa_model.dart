// File: lib/app/models/rapor_siswa_model.dart
...
class RaporMapelModel {
  ...
  final List<UnitCapaian> daftarCapaian;
  final String? deskripsiCapaian; // <-- TAMBAHKAN FIELD BARU DI SINI
  ...
  RaporMapelModel({
    ...
    this.deskripsiCapaian, // <-- TAMBAHKAN DI KONSTRUKTOR
  });
}
